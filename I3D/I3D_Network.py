...
from I3D.InceptionModule import InceptionModule
from I3D.MaxPool3dSamePadding import MaxPool3dSamePadding
from I3D.Unit3D import Unit3D


class InceptionI3d(nn.Module):
    def __init__(self, num_classes=400, spatial_squeeze=True,
                 name='inception_i3d', in_channels=3, dropout_keep_prob=0.5, model_dir='model/rgb_imagenet.pt'):
        ...
        self.logits = Unit3D(in_channels=384 + 384 + 128 + 128, output_channels=self._num_classes,
                             ...
                             name='logits')
        self.build()
        self.load_pretrained_weights(model_dir)
    ...
    def forward(self, x):
        ...
        return x.squeeze(3).squeeze(3) if self._spatial_squeeze else x  # Batch_Size X Frame_Num X Class_Num
